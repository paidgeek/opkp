      ...
      return {
         ...
         link: function(f, g, h) {
            ...
            var o = function(a) {
               ...
               p = i;
            f.edit = function() {
               return f.aceEditor ? (f.editActivated ? (j && (document.getElementById(f.id).env = null), n(p), i = p, f.parsable = !1) : (p = i, j = ace.edit(f.id), j.setAutoScrollEditorIntoView(!0), j.setOptions({
                  maxLines: 1 / 0
